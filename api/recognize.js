...
{
  "clothingName": "<Generate a confident, realistic product-style name. If the item is simple (plain pants, plain shirt, plain jeans), return a descriptive name like 'black pants'.>",
  ...
  "subtype": "<hoodie | t-shirt | jeans | joggers | sneakers | boots | jacket | pants>"
}
